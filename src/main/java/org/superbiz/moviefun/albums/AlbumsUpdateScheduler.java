...
public class AlbumsUpdateScheduler {
    ...
    private final DataSource albumDataSource;
    private final Logger logger = LoggerFactory.getLogger(getClass());
    private final JdbcTemplate jdbcTemplate;

    public AlbumsUpdateScheduler(AlbumsUpdater albumsUpdater, DataSource albumDataSource) {
        this.albumsUpdater = albumsUpdater;
        this.albumDataSource = albumDataSource;
        this.jdbcTemplate = new JdbcTemplate(albumDataSource);
    }
